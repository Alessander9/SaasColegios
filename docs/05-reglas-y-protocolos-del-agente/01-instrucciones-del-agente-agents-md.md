...
<!-- Fuente original: cole.txt (Líneas 5554 a 5906) -->
...
[⬅️ Anterior: 20. Plan de Implementación Maestro v1.0](../04-plan-de-implementacion-optimizado/20-plan-de-implementacion-maestro.md) | [🏠 Índice Principal](../README.md) | [Siguiente: 02. La Regla Más Importante para el Agente ➡️](./02-reglas-fundamentales-para-el-agente.md)
